...
<title>Proposta - Gestão de Processos Judiciais</title>
<style>
...
<div class="container">
  ...
  <div class="date-location">Salvador/BA, 20 de fevereiro de 2026.</div>
  <div class="parties">
    <div class="party">
  ...
  <div class="footer">Alessandra Hoffmann — Consultoria Estratégica | CNPJ 61.416.957/0001-08 | (11) 97127-1806</div>
</div>
</body>
</html>`;
...
<meta charset="UTF-8">
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<title>Proposta - Gestão do Passivo Tributário</title>
<style>
  @import url('https://fonts.googleapis.com/css2?family=Playfair+Display:wght@400;600;700&family=Inter:wght@300;400;500;600&display=swap');
  * { margin: 0; padding: 0; box-sizing: border-box; }
  body { font-family: 'Inter', sans-serif; color: #2d2d2d; line-height: 1.7; background: #faf8f5; }
...
<div class="container">
  ...
  <div class="section">
    ...
    <table class="value-table">
      <thead><tr><th>Inscrição</th><th>Tributo</th><th>Valor Consolidado</th></tr></thead>
      <tbody>
        <tr><td>50 6 20 017185-30</td><td>CSLL — Contribuição Social sobre o Lucro Líquido</td><td>R$ 998.932,17</td></tr>
        <tr><td>50 2 20 005103-09</td><td>IRPJ — Imposto de Renda Pessoa Jurídica</td><td>R$ 2.828.867,52</td></tr>
        <tr class="total-row"><td colspan="2"><strong>TOTAL DO PASSIVO FEDERAL</strong></td><td><strong>R$ 3.827.799,69</strong></td></tr>
      </tbody>
    </table>
    <div class="note-box">
...
async function main() {
  try {
    // Update proposta 1
    await db.execute(sql`UPDATE documentos SET htmlContent = ${proposta1Html} WHERE fileKey = 'proposta-processos-judiciais'`);
    console.log("✅ Proposta 1 atualizada com HTML");

    // Update proposta 2
    await db.execute(sql`UPDATE documentos SET htmlContent = ${proposta2Html} WHERE fileKey = 'proposta-passivo-tributario'`);
    console.log("✅ Proposta 2 atualizada com HTML");

    console.log("\n✅ Ambas as propostas atualizadas com conteúdo HTML!");
    process.exit(0);
  } catch (err) {
