      ...
      <Card className="bg-gradient-to-r from-[#d4553a] to-[#b8432e] text-white border-0">
        <CardContent className="p-6">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div>
              <p className="text-sm text-white/70 uppercase tracking-wider">Passivo Total PGFN</p>
              <p className="text-3xl md:text-4xl font-bold mt-1">{formatCurrency(totalPassivo)}</p>
              <p className="text-sm text-white/60 mt-2">IRPJ + CSLL — Períodos de 2007</p>
            </div>
